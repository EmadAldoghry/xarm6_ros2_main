...
def launch_setup(context, *args, **kwargs):
    ...
    mod = load_python_launch_file_as_module(os.path.join(get_package_share_directory('xarm6_api'), 'launch', 'lib', 'robot_api_lib.py'))
    generate_robot_api_params = getattr(mod, 'generate_robot_api_params')
    robot_params = generate_robot_api_params(
        os.path.join(get_package_share_directory('xarm6_api'), 'config', 'xarm_params.yaml'),
        os.path.join(get_package_share_directory('xarm6_api'), 'config', 'xarm_user_params.yaml'),
